...
namespace IdentityServer.IntegrationTests.Clients
{
    public class CustomTokenResponseClients
    {
        ...
        public async Task Resource_owner_success_should_return_custom_response()
        {
            ...
            fields.Should().ContainKey("string_value").WhoseValue.Should().BeOfType<JsonElement>().Subject.GetString().Should().Be("some_string");
            fields.Should().ContainKey("int_value").WhoseValue.Should().BeOfType<JsonElement>().Subject.GetInt64().Should().Be(42);
            ...
            payload.Should().ContainKey("iss").WhoseValue.GetString().Should().Be("https://idsvr4");
            payload.Should().ContainKey("client_id").WhoseValue.GetString().Should().Be("roclient");
            payload.Should().ContainKey("sub").WhoseValue.GetString().Should().Be("bob");
            payload.Should().ContainKey("idp").WhoseValue.GetString().Should().Be("local");

            payload.Should().ContainKey("aud").WhoseValue.GetString().Should().Be("api");

            var scopes = ((JsonElement)payload["scope"]).EnumerateArray().ToList();
            scopes.First().ToString().Should().Be("api1");

            var amr = ((JsonElement)payload["amr"]).EnumerateArray().ToList();
        ...
        public async Task Extension_grant_success_should_return_custom_response()
        {
            ...
            fields["string_value"].Should().BeOfType<JsonElement>().Subject.GetString().Should().Be("some_string");

            fields.Should().ContainKey("int_value");
            fields["int_value"].Should().BeOfType<JsonElement>().Subject.GetInt64().Should().Be(42);
            ...
            payload.Should().ContainKey("iss").WhoseValue.Should().BeOfType<JsonElement>().Subject.GetString().Should().Be("https://idsvr4");
            payload.Should().ContainKey("client_id").WhoseValue.Should().BeOfType<JsonElement>().Subject.GetString().Should().Be("client.custom");
            payload.Should().ContainKey("sub").WhoseValue.Should().BeOfType<JsonElement>().Subject.GetString().Should().Be("bob");
            payload.Should().ContainKey("idp").WhoseValue.Should().BeOfType<JsonElement>().Subject.GetString().Should().Be("local");
            payload.Should().ContainKey("aud").WhoseValue.Should().BeOfType<JsonElement>().Subject.GetString().Should().Be("api");

            payload.Should().ContainKey("scope").WhoseValue.Should().BeOfType<JsonElement>().Subject.EnumerateArray().First().GetString().Should().Be("api1");

            var amr = (JsonElement)payload["amr"];
            amr.EnumerateArray().Count().Should().Be(1);
            amr.EnumerateArray().First().ToString().Should().Be("custom");
